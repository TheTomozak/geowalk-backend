...
insert into blog_post (title, content, creation_date_time, last_edit_date_time, user_id, visible, number_of_visits) values
    ...
    ('Amerykański sen','Ciekawa i historyczna wycieczka po Zamku.', '2021-08-15', null, 3, true,2),                                     --2
    ('Musisz to zoaczyć','Dzisiaj byłem w Watykanie. Swietne miejsce, daje dużo do myślenia!', '2021-07-15', null, 1, true,3),            --3
    ('MEGA Watykan','Niesamowicie bylo zwiedzic chociaz troche Egipt. Wycieczka Quadami mega.', '2021-07-01', null, 2, true,2),      --4
    ('Ameryka LOVE','Bardzo Amerykanskie i bardzo ciekawe przystanki. Zachecam do czytania dalej.', '2021-06-09', null, 3, true,66),  --5
...
insert into blog_comment(content, creation_date_time, rating, user_id, visible, blog_post_id) values
    ...
    ('Calkiem fajna :)','2021-10-23', 4, 4, true, 4),                      --4

    ('Slabe', '2021-09-10', 1, 8,true, 1),                                 --5
    ('Wgl nie ciekawe', '2021-09-17', 1, 5,true,5),                       --6
    ('Mmm myslalem ze lepsze', '2021-08-29', 1, 6,true, 5),                --7
    ('Moglo byc wiecej informacji', '2021-10-10', 1, 7,true ,3),           --8
    ('Usuniety kom na 1!', '2021-10-10', 1, 5,false, 4),                   --9

    ('Moze byc', '2021-11-12', 2, 4,true, 1),                              --10
    ('ok', '2021-10-10', 2, 5,true, 6),                                    --11
    ('Chyba niebezpiecznie', '2021-12-17', 2, 8,true, 2),                  --12
    ('Nudne', '2021-10-10', 2, 7,true,3),                                 --13
    ('Usuniety kom na 2@', '2021-08-28', 2, 6,false,4),                   --14

    ('Dzieki za artykol', '2021-11-18', 3, 5,true, 1),                     --15
    ('Nie poniosło ale duzo informacji', '2021-09-19', 3, 5,true,6),      --16
    ('Fajny', '2021-10-19', 3, 7,true,4),                                 --17
    ('A o czym to', '2021-10-18', 3, 7,true,4),                           --18
    ('Usuniety kom na 3#', '2021-10-15', 3, 7,false,2),                   --19

    ('Przyjemnie sie czytało', '2021-12-14', 4, 6,true, 1),                --20
    ('Oooo o wielu rzeczach nie wiedzialem', '2021-12-24', 4, 5,true, 2),  --21
    ('Duzo swierzych informacji', '2021-11-28', 4, 5,true, 2),             --22
    ('Wysle znajomym, dzieki', '2021-09-30', 4, 6,true,3),                --23
    ('Usuniety kom na 4$', '2021-08-18', 4, 8,false,6),                   --24

    ('Super artykol!!!!', '2021-09-10', 5, 5,true, 1),                     --25
    ('Ciekawe, ciekawe i jeszcze raz ciekawe', '2021-12-01', 5, 7,true,3),--26
    ('Ocena na pięć', '2021-11-12', 5, 7,true,5),                         --27
    ('Rzetelne i na temat', '2021-10-29', 5, 6,true,2),                   --28
    ('Piateczka!', '2021-08-24', 5, 8,true,2),                            --29
    ('Usuniety kom na 5%', '2021-09-05', 5, 1,false, 4),                   --30

    ('Nie powinno sie wspierac hazardu', '2021-11-22', 2, 5, true, 1),     --31
